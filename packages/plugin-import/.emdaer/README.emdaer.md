...
### Example
Import a plain markdown file like so:</br>
<!--emdaer-p
...
Import and call a function that returns/resolves a string like so: A function named `printThrice` is called with the string `Hello world! x3`:</br>
<!--emdaer-p
  - '@emdaer/plugin-import'
